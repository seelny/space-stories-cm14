...
command-description-animationtest-setlayerstate = Устанавливает состояние для определённого слоя на сущности на 3 секунды.
command-description-animationtest-flick = Проигрывает анимацию из RSI на сущности, один раз.
command-description-nearbytile = Получает ссылки на тайлы (TileRef) в указанном радиусе вокруг сущностей.
command-description-tiletype-FromProtoId = Возвращает список ссылок на тайлы (TileRef), соответствующих указанному id прототипа. (Инвертируемый)
command-description-tiletype-FromTileId = Возвращает список ссылок на тайлы (TileRef), соответствующих указанному id тайла (Tile Definition Id). (Инвертируемый)
command-description-replacetile-FromProtoId = Заменяет тайлы на указанный id прототипа.
command-description-replacetile-FromTileId = Заменяет тайлы на указанный id тайла.
command-description-gridtile = Получает ссылки на тайлы (TileRef) для грида, в которую входит указанная сущность.
command-description-movespeed = Изменяет максимальную скорость передвижения для заданных сущностей.
command-description-stairwell = Устанавливает смещение для телепортации данных сущностей типа Teleporter.
command-description-stairwellprojector = Устанавливает ID проекции для данных сущностей типа TeleporterView.
command-description-getusername = Получает имя пользователя, привязанное к сущности.
