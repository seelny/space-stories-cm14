...
rmc-xeno-parasite-ghost-carrier-none = { THE($xeno) } не имеет укрытых лицехватов!
rmc-xeno-parasite-ghost-carrier-reserved = { THE($xeno) } зарезервировал оставшихся лицехватов для { REFLEXIVE($xeno) }.
