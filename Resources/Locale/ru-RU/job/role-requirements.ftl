...
role-timer-age-to-old = Возраст вашего персонажа должен быть не старше [color=yellow]{ $age }[/color], чтобы сыграть эту роль.
role-timer-age-to-young = Возраст вашего персонажа должен быть не моложе [color=yellow]{ $age }[/color], чтобы сыграть эту роль.
